...
#'
#' @param input_file A -v7.3 .mat file output from the adamjtaylor/nextflow_msi pipeline.
#'
#' @return A csv file containing mz values, index, tb_ratio and spatial chaos for peaks with tb_ratio > 0
#' @export
#'
#' @examples
